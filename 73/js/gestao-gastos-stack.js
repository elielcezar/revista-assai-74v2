 ...
 * partir da sobreposição real entre cards (getBoundingClientRect) — mesma
 * técnica de js/gestao-conceitos-stack.js.
 */
(function () {
  "use strict";

  var cards = Array.prototype.slice.call(
    document.querySelectorAll("#gestao-gastos-stack .gestao-gastos-card")
  );
  if (cards.length < 2) return;

  var inners = cards.map(function (card) {
    return card.querySelector(".gestao-gastos-card__inner");
  });
